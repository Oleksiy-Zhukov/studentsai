...
from .database import (
    get_db, create_tables, get_notes_by_user, get_note_by_id,
    create_note, update_note, delete_note, get_flashcards_by_note,
    create_flashcard
)
from .schemas import (
    UserCreate, UserLogin, Token, NoteCreate, NoteUpdate, NoteResponse,
    NoteListResponse, FlashcardResponse, SummarizeRequest, SummarizeResponse,
    GenerateFlashcardsRequest, GenerateFlashcardsResponse, GraphResponse,
    ErrorResponse, SuccessResponse, GraphNode, NoteConnection
)
from .auth import (
    authenticate_user, register_user, get_current_user, get_current_user_id,
    create_access_token
)
from .rate_limiter import (
    check_rate_limit, check_ai_rate_limit, check_auth_rate_limit
)
from .ai_service import (
    summarize_content, generate_flashcards_from_content, calculate_note_similarities
)
...
@app.post("/notes/{note_id}/flashcards/generate", response_model=List[FlashcardResponse])
async def generate_note_flashcards(
    ...
    try:
        generated_flashcards = await generate_flashcards_from_content(note.content, count)
        ...
        for flashcard_data in generated_flashcards:
            ...
            saved_flashcards.append(FlashcardResponse(
                id=flashcard.id,
                question=flashcard.question,
                answer=flashcard.answer,
                difficulty=flashcard.difficulty,
