...
export function FinalCta({ title, subtext, buttonLabel = 'More options', buttonHref = '#plans' }: FinalCtaProps) {
	return (
			...
			<div className="rounded-md border border-gray-200 bg-white p-6 text-center dark:border-[#232a36] dark:bg-[#141820]">
				...
				<div className="mt-6 flex justify-center gap-3">
					<Link href={buttonHref}>
						<Button variant="outline" className="dark:border-[#232a36]">{buttonLabel}</Button>
					</Link>
				</div>
			</div>
		</section>
